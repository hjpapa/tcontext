...
/**
 * Exact renderer used before prompt version 1.6. It remains available only to
 * verify previously consented Markdown without downgrading legacy documents.
 */
export function profileToLegacyMarkdownV1(
  input: TeacherContextProfile,
): string {
